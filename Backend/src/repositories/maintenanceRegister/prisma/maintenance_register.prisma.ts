...
import { MaintenanceRegisterRepository } from "../maintenance_register.repository";
import {
  MaintenanceProps,
  MaintenanceRegister,
...
export class MaintenanceRegisterPrisma
  implements MaintenanceRegisterRepository
{
  private constructor(readonly prisma: PrismaClient) {}

  public static build(prisma: PrismaClient) {
    return new MaintenanceRegisterPrisma(prisma);
  }
